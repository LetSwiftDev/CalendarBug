...
- (void)viewWillTransitionTo:(CGSize)size with:(id <UIViewControllerTransitionCoordinator> _Nonnull)coordinator focusDateIndexPathAfterRotate:(NSIndexPath * _Nullable)focusDateIndexPathAfterRotate SWIFT_DEPRECATED_OBJC("Swift method 'JTAppleCalendarView.viewWillTransition(to:with:focusDateIndexPathAfterRotate:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Lays out subviews.
- (void)layoutSubviews;
